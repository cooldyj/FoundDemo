...
import com.chinayszc.mobile.module.home.adapter.ExpiredListAdapter;
import com.chinayszc.mobile.module.home.adapter.UsedListAdapter;
...
public class ExpiredListView extends BaseListView<CouponModel> {

    private int pageSize = 1;         //当前页

    public ExpiredListView(LRecyclerView recyclerView, Context context) {
        super(recyclerView, context);
    }

    @Override
    public void setAdapter() {
        adapter = new ExpiredListAdapter(context);
    }
    ...
    private void loadData(boolean isLoadMore) {
        ...
        OkHttpUtils.post().url(Urls.EXPIRED)

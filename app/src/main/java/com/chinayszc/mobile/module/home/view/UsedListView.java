...
public class UsedListView extends BaseListView<CouponModel> {

    private int pageSize = 1;         //当前页

    public UsedListView(LRecyclerView recyclerView, Context context) {
        super(recyclerView, context);
    }

    @Override
    public void setAdapter() {
        adapter = new UsedListAdapter(context);
    }
    ...
    private void loadData(boolean isLoadMore) {
        ...
        OkHttpUtils.post().url(Urls.USED)

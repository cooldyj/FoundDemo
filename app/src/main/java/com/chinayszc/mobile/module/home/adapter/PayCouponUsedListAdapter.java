...
public class PayCouponUsedListAdapter extends BaseListAdapter<CouponModel> {

    public PayCouponUsedListAdapter(Context context) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (null != model) {
            ...
            viewHolder.usedIcon.setVisibility(View.GONE);

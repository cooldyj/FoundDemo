...
public class CustomDialog extends Dialog {
    ...
    private void resizeDialog(Dialog dialog){
        ...
        lps.width = Env.screenWidth - DisplayUtils.convertDIP2PX(dialog.getContext(), 20) * 2;
    ...
    public static class Builder {
        ...
        private void buildDialog(final CustomDialog dialog) {
            View view = LayoutInflater.from(context).inflate(R.layout.app_common_dialog, null);
            LinearLayout contentLL = (LinearLayout) view.findViewById(R.id.dialog_content);
            TextView negativeTV = (TextView) view.findViewById(R.id.dialog_reset);
            TextView positiveTV = (TextView) view.findViewById(R.id.dialog_save);
